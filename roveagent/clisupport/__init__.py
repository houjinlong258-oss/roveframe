"""
RoveAgent CLI - Unified command-line interface for RoveAgent Agent.

Provides subcommands for:
- roveagent chat          - Interactive chat (same as ./roveagent)
- roveagent gateway       - Run gateway in foreground
- roveagent gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `roveagent setup` on a fresh Pi.
    ...
    roveagent_cli/stdio.py::configure_windows_stdio() runs later from the entry
