...
``tests/roveagent_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — RoveAgent Agent</title>
<style>
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the RoveAgent Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — RoveAgent Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
See the <a href="https://roveagent-agent.nousresearch.com/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
