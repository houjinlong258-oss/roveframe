...
How it fits the existing auth framework:
  ...
  * :func:`token_auth_middleware` runs OUTERMOST (installed last in
    ...
    :class:`~roveagent_cli.dashboard_auth.base.TokenPrincipal` to
...
from roveagent.clisupport.dashboard_auth import list_token_providers
from roveagent.clisupport.dashboard_auth.audit import AuditEvent, audit_log
from roveagent.clisupport.dashboard_auth.base import ProviderError, TokenPrincipal
