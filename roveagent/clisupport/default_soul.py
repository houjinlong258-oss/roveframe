"""Default SOUL.md template seeded into ROVEAGENT_HOME on first run."""
...
_LEGACY_TEMPLATE_SOULS = (
    (
        ...
        "Edit this to customize how RoveAgent communicates with you.\n"
        "\n"
        "Examples:\n"
    ...
    (
        "You are RoveAgent Agent, an intelligent AI assistant created by Nous "
