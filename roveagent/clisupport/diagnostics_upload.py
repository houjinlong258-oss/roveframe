"""Client for uploading ``roveagent debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``roveagent debug share``.
...
NAS_BASE = os.environ.get(
    "ROVEAGENT_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "roveagent-agent/debug-share"
