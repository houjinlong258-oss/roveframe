...
from roveagent.core.models_dev import ModelInfo, PROVIDER_TO_MODELS_DEV
...
class ExpensiveModelWarning:
    """Confirmation payload for models above RoveAgent' cost guardrail."""
...
def _can_trust_pricing_lookup(
    ...
    *,
    ...
    try:
        from roveagent.core.usage_pricing import resolve_billing_route
...
def expensive_model_warning(
    ...
    *,
    ...
    lines = [
        ...
        "",
        f"{model} has known pricing above RoveAgent' safety threshold.",
