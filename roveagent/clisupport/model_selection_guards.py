...
RoveAgent has multiple model-selection surfaces (CLI picker, TUI, dashboard,
...
from roveagent.core.models_dev import ModelInfo
...
def _cost_guard(
    ...
    from roveagent.clisupport.model_cost_guard import expensive_model_warning
...
def _data_policy_guard(
    ...
    from roveagent.clisupport.model_data_policy_guard import data_training_warning
