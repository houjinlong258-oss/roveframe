"""Relay subscriber for the persisted RoveAgent shared-metrics slice."""
...
from roveagent.core.relay_runtime import RUNTIME_INSTANCE_KEY
...
class SharedMetricsSubscriber:
    """Persist validated RoveAgent counters from Relay lifecycle events."""

    def __init__(
        self,
        store: SharedMetricsStore,
        roveagent_version: str,
        *,
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the RoveAgent shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
