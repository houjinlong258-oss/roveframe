...
from roveagent.clisupport.proxy.adapters.base import UpstreamAdapter
from roveagent.clisupport.proxy.adapters.nous_portal import NousPortalAdapter
from roveagent.clisupport.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``roveagent proxy start --provider <name>`` CLI flag.
