...
Entry point: ``roveagent whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``roveagent_cli/main.py``).
...
RoveAgent gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures RoveAgent to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  RoveAgent needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the RoveAgent gateway in another terminal:")
    print("         roveagent gateway")
    print()
    ...
    print()
    print("  Docs: https://roveagent-agent.nousresearch.com/docs/user-guide/")
