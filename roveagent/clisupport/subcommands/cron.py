"""``roveagent cron`` subcommand parser.

Extracted verbatim from ``roveagent_cli/main.py:main()`` — same arguments, same
...
def build_cron_parser(subparsers, *, cmd_cron: Callable) -> None:
    ...
    cron_create.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.roveagent/scripts/. Default mode: "
    ...
    cron_create.add_argument(
        ...
        help=(
            ...
            "~/.roveagent/scripts/ that runs each tick BEFORE the agent. "
    ...
    cron_create.add_argument(
        ...
        help=(
            ...
            "roveagent.cron.model / model.default from config.yaml."
        ),
    )
    cron_create.add_argument(
        "--provider",
    ...
    cron_edit.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.roveagent/scripts/. Pass empty string to clear. "
    ...
    cron_edit.add_argument(
        ...
        dest="monitor_script",
        help=(
            "Set/replace the monitor source script (see `roveagent cron create "
