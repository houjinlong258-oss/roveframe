"""``roveagent tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'roveagent tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # roveagent tools list [--platform cli]
    ...
    # roveagent tools disable <name...> [--platform cli]
    ...
    # roveagent tools enable <name...> [--platform cli]
    ...
    # roveagent tools post-setup <key>
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `roveagent tools` runs after you pick a provider that\n"
