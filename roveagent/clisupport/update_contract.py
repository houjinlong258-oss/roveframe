...
``roveagent update`` mutation (CLI apply, CLI --check, dashboard update
endpoint). The decision layers:

1. **Baked provenance marker** (``/etc/roveagent/image-provenance.json``,
   written by the image build — see :mod:`roveagent_cli.image_provenance`):
