...
_RECOVERY_ENV = "ROVEAGENT_UPDATE_RESTART_RECOVERY"
_GATEWAY_MARKERS = ("_ROVEAGENT_GATEWAY", "ROVEAGENT_GATEWAY", "ROVEAGENT_GATEWAY_MODE")
...
def _systemd_unit_candidates(profile: str) -> tuple[str, ...]:
    ...
    if profile == "default":
        return (
            "roveagent-gateway.service",
            "roveagent.gateway.service",
            "gateway-default.service",
        )
    return (
        f"roveagent-gateway-{profile}.service",
