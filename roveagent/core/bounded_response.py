...
When a provider returns a non-OK status on a *streaming* request, RoveAgent reads
...
streams"), generalized to cover RoveAgent's three streaming error-body sites
