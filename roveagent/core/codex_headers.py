...
def codex_cloudflare_headers(
    ...
    the official endpoint always send RoveAgent' originator and version. Custom
    ...
    """
    headers = {
        "User-Agent": "codex_cli_rs/0.0.0 (RoveAgent Agent)",
    ...
    if is_official_codex_base_url(base_url):
        ...
        headers.update({
            "User-Agent": f"RoveAgentAgent/{__version__}",
            "originator": "roveagent-agent",
        })
