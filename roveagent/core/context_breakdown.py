...
def compute_session_context_breakdown(
    ...
    from roveagent.core.model_metadata import anchored_context_tokens
...
def compute_context_details(agent: Any) -> Dict[str, Any]:
    ...
    Reuses the ``roveagent prompt-size`` attribution mechanism (PR #66656):
    ...
    """
    from roveagent.clisupport.prompt_size import (
