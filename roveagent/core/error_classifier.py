...
# ``data:`` field before RoveAgent receives a completion chunk.  Keeping this
...
# See: https://github.com/NousResearch/roveagent-agent/issues/69078
...
#
# See: https://github.com/NousResearch/roveagent-agent/issues/27344
...
# case: a stream dies mid-response and RoveAgent persists a content-less
...
# Request parameters that RoveAgent sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # roveagent_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from roveagent.clisupport.plugins import get_plugin_error_classification
    ...
    from roveagent.core.errors import MoAPresetNotFoundError
