...
def build_error_surface_from_result(
    ...
    try:
        ...
        # provider stack, and roveagent_state owns the pattern list.
        try:
            from roveagent.state import is_disk_full_error
...
def build_error_surface_from_exception(
    ...
    try:
        ...
        from roveagent.core.error_classifier import classify_api_error
