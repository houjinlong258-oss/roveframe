...
def _supports_vision_override(
    ...
    *,
    ...
    # (roveagent_cli/runtime_provider.py:_resolve_named_custom_runtime), so the
...
def _resolve_inference_base_url(
    ...
    try:
        from roveagent.core.auxiliary_client import _runtime_main_value
...
def _should_probe_ollama_vision(
    ...
    if p != "ollama":
        try:
            ...
            return False
    try:
        from roveagent.core.model_metadata import detect_local_server_type
...
def _lookup_supports_vision(
    ...
    *,
    ...
    if _should_probe_ollama_vision(provider, base_url, api_key=resolved_api_key):
        try:
            from roveagent.core.model_metadata import query_ollama_supports_vision
