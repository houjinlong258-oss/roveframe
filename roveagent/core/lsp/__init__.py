"""Language Server Protocol (LSP) integration for RoveAgent Agent.

RoveAgent runs full language servers (pyright, gopls, rust-analyzer,
...
from roveagent.core.lsp.manager import LSPService

logger = logging.getLogger("roveagent.core.lsp")
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``roveagent chat`` exit would leak pyright processes that
