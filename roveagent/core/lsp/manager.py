...
from roveagent.core.lsp import eventlog
from roveagent.core.lsp.client import (
    DIAGNOSTICS_DOCUMENT_WAIT,
    LSPClient,
)
from roveagent.core.lsp.servers import (
    ServerContext,
    find_server_for_file,
    language_id_for,
)
from roveagent.core.lsp.workspace import (
    clear_cache,
    resolve_workspace_for_file,
)

logger = logging.getLogger("roveagent.core.lsp.manager")
...
class LSPService:
    ...
    def create_from_config(cls) -> Optional["LSPService"]:
        """Build a service from ``roveagent_cli.config`` settings.
    ...
    def enabled_for(self, file_path: str) -> bool:
        ...
        timeout cost — until the service is restarted (``roveagent lsp
        ...
        if delta:
            ...
            if baseline:
                if line_shift is not None:
                    ...
                    from roveagent.core.lsp.range_shift import shift_baseline
    ...
    # ------------------------------------------------------------------
    # status / introspection (used by ``roveagent lsp status``)
    # ------------------------------------------------------------------
