...
(3 SDK retries x 3 RoveAgent retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_roveagent_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".roveagent")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, RoveAgent, ...) behind one endpoint.  A 429 can mean either:
