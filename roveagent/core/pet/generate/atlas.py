"""Deterministic spritesheet assembly — generated row strips → RoveAgent atlas.
...
from roveagent.core.pet.constants import FRAME_H, FRAME_W
...
def compose_atlas(frames_by_state: dict[str, list]):
    """Pack per-state frame lists into the RoveAgent atlas (RGBA, residue-cleared).
