"""Core NeMo Relay adapter for RoveAgent tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the RoveAgent tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous RoveAgent Relay tool execution cannot run on an active event-loop thread"
    )
