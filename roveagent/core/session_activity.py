...
class ActivityProvenance(str, Enum):
    ...
    AGENT_COMPRESSION = "roveagent.core.compression"
    AGENT_COMPRESSION_TIMEOUT = "roveagent.core.compression_timeout"
    AGENT_COMPRESSION_COOLDOWN = "roveagent.core.compression_cooldown"
    AGENT_COMPRESSION_TURNHOLD = "roveagent.core.compression_turnhold"
