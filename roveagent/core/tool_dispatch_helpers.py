...
from roveagent.core.message_metadata import stamp_message_timestamp
from roveagent.core.tool_result_classification import (
    FILE_MUTATING_TOOL_NAMES as _FILE_MUTATING_TOOLS,
)
from roveagent.tools.threat_patterns import scan_for_threats
...
def _is_mcp_tool_parallel_safe(tool_name: str) -> bool:
    ...
    """
    try:
        from roveagent.tools.mcp_tool import is_mcp_tool_parallel_safe
...
def _peel_bridge_call(tool_name: str, function_args: dict) -> tuple[str, dict]:
    ...
    """
    try:
        from roveagent.tools.tool_search import TOOL_CALL_NAME, resolve_underlying_call
...
_UPSTREAM_ELISION_NOTICE = (
    '\n[roveagent note: this result contains provider-side elision markers '
