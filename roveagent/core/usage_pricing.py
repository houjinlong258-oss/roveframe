...
from roveagent.core.model_metadata import fetch_endpoint_model_metadata, fetch_model_metadata
...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Fireworks AI — serverless pricing for the models roveagent typically routes
...
# onto the base entries so the snapshot stays single-source. The RoveAgent-side
