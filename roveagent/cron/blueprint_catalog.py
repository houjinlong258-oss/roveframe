...
renders natively:
  ...
  * Docs catalog          -> a copy-paste command + a ``roveagent://`` deep-link
...
def blueprint_deeplink(blueprint: AutomationBlueprint, values: Optional[Dict[str, Any]] = None) -> str:
    """Build the ``roveagent://blueprint/<key>?slot=val`` deep-link URL."""
    ...
    return f"roveagent://blueprint/{quote(blueprint.key)}{qs}"
