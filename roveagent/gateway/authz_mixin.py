...
(``~/.roveagent/plans/god-file-decomposition.md``, Phase 3 mechanical mixin lifts).
...
(``"roveagent.gateway.run"``) so log records are unchanged.
"""
...
class GatewayAuthorizationMixin:
    ...
    def _adapter_group_has_sender_allowlist(
        ...
        *,
        ...
        restricting which senders inside that group can invoke RoveAgent. If such a
    ...
    def _is_user_authorized(
        ...
        *,
        ...
        5. Default: deny
        """
        from roveagent.gateway.run import logger
        ...
        # (roveagent gateway pairing approve / the authenticated dashboard) — an
        ...
        # (``load_roveagent_dotenv(override=True)`` in
