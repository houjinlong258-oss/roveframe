...
Hooks are discovered from ~/.roveagent/hooks/ directories, each containing:
...
Context dict passed to ``agent:start`` / ``agent:end`` handlers:
  ...
  session_id   -- RoveAgent session id
...
HOOKS_DIR = get_roveagent_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"roveagent_hook_{hook_name}"
