...
from environment variables:
  ...
  - ``ROVEAGENT_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``ROVEAGENT_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``ROVEAGENT_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``roveagent cron run`` in the CLI, ``roveagent send``, a
...
_STRICT_ENV = "ROVEAGENT_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "ROVEAGENT_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "ROVEAGENT_MEDIA_TRUST_RECENT_FILES"
