...
from roveagent.gateway.platforms.webhook_filters import (
...
class WebhookAdapter(BasePlatformAdapter):
    ...
    def toolsets_for_source(self, source) -> Optional[List[str]]:
        ...
        exposed through `roveagent webhook subscribe`, so an agent-created
    ...
    def _reload_dynamic_routes(self) -> None:
        ...
        subs_path = roveagent_home / _DYNAMIC_ROUTES_FILENAME
