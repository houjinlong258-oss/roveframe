...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your RoveAgent session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show RoveAgent session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running RoveAgent agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update RoveAgent Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the RoveAgent gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a RoveAgent session in it",
