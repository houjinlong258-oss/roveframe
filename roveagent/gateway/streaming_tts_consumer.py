...
from roveagent.gateway.platforms.base import AudioFormat, StreamingTTSHandle

logger = logging.getLogger("roveagent.gateway.streaming_tts_consumer")
...
class StreamingTTSConsumer:
    ...
    def _strip_markdown_for_tts(self, text: str) -> str:
        ...
        if self._strip_markdown is None:
            try:
                from roveagent.tools.tts_tool import _strip_markdown_for_tts as _strip
