...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$ROVEAGENT_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_roveagent_dir("platforms/whatsapp/session", "whatsapp/session")
