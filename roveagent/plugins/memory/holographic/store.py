...
Single-user RoveAgent memory store plugin.
"""
...
class MemoryStore:
    ...
    def __init__(
        ...
        if db_path is None:
            ...
            db_path = str(get_roveagent_home() / "memory_store.db")
    ...
    def _init_db(self) -> None:
        ...
        # gracefully on NFS/SMB/FUSE-mounted ROVEAGENT_HOME (same issue as
        # state.db / kanban.db — see roveagent_state._WAL_INCOMPAT_MARKERS).
    ...
    def search_facts(
        ...
        with self._lock:
            ...
            from roveagent.plugins.memory.holographic.retrieval import FactRetriever
