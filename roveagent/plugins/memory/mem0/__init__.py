...
Configuration
-------------
Secret (lives in $ROVEAGENT_HOME/.env or the environment):
...
Behavioral settings (live in $ROVEAGENT_HOME/mem0.json, set via `roveagent memory
setup`):
  ...
  agent_id           — Agent identifier (default: roveagent)
...
_DEFAULT_USER_ID = "roveagent-user"
...
def _load_config() -> dict:
    """Load config from env vars, with $ROVEAGENT_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "roveagent"),
        "oss": {},
    }
    ...
    config_path = get_roveagent_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, roveagent_home):
        """Write config to $ROVEAGENT_HOME/mem0.json."""
        import json
    ...
    def post_setup(self, roveagent_home: str, config: dict) -> None:
        ...
        post_setup(roveagent_home, config)
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $ROVEAGENT_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "roveagent")
