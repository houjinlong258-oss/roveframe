...
from roveagent.core.transports.codex import _cache_scope_from_session_id
...
class OpenRouterProfile(ProviderProfile):
    ...
    def fetch_models(
        ...
        *,
        ...
        Note: Tool-call capability filtering is applied by roveagent_cli/models.py
    ...
    def build_api_kwargs_extras(
        ...
        **context: Any,
        ...
        if supports_reasoning:
            ...
            # model default to adaptive. See roveagent-agent#42991 (disable case)
            ...
            # live token-spend probe in roveagent-agent#43432). Route the existing
