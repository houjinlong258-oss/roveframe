...
# When the user hasn't picked a reasoning effort, RoveAgent passes
...
# ON at this effort — matching the "medium (default)" that RoveAgent' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map RoveAgent' effort vocabulary onto Solar's accepted set via the
        ...
        from roveagent.core.reasoning_effort import EFFORT_LADDER, SOLAR_EFFORTS, clamp_effort
