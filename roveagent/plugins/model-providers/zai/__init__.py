...
request omits ``thinking``.  RoveAgent' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the RoveAgent reasoning
...
(per Z.AI / BigModel docs).  RoveAgent' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map RoveAgent reasoning effort onto GLM's native vocabulary.
