...
from roveagent.gateway.platforms.helpers import MessageDeduplicator, compile_mention_patterns
...
class DingTalkAdapter(BasePlatformAdapter):
    ...
    async def send(
        ...
        payload = {
            "msgtype": "markdown",
            "markdown": {"title": "RoveAgent", "text": normalized},
        }
    ...
    async def _create_and_stream_card(
        ...
        *,
        ...
        try:
            ...
            out_track_id = f"roveagent_{uuid.uuid4().hex[:12]}"
...
# dict in roveagent_cli/gateway.py, and the _send_dingtalk dispatch in
...
async def _standalone_send(
    ...
    *,
    ...
    try:
        ...
        try:
            from roveagent.tools.send_message_tool import _error as _redact_error
...
def interactive_setup() -> None:
    ...
    Replaces roveagent_cli/setup.py-era _setup_dingtalk + the static
    _PLATFORMS["dingtalk"] dict in roveagent_cli/gateway.py. CLI helpers are
    ...
    if method == 0:
        try:
            from roveagent.clisupport.dingtalk_auth import dingtalk_qr_auth
