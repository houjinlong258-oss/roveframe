...
class DiscordRecoveryStore:
    ...
    def __init__(self, roveagent_home: Path | None = None) -> None:
        self._lock = threading.Lock()
        self._initialized = False
        self._roveagent_home = Path(roveagent_home or get_roveagent_home())

    def path(self) -> Path:
        directory = self._roveagent_home / "gateway"
