...
Config: ~/.roveagent/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.roveagent/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_roveagent_home()`` helper (ROVEAGENT_HOME-aware and
...
RULES_FILE = get_roveagent_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_roveagent_home() / "feishu_comment_pairing.json"
