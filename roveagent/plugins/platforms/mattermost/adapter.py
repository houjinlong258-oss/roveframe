...
required — uses aiohttp which is already a RoveAgent dependency.
        ...
        for fid in file_ids:
            try:
                ...
                async with self._session.get(
                    ...
                    if resp.status < 400:
                        file_data = await resp.read()
                        from roveagent.gateway.platforms.base import cache_image_from_bytes, cache_document_from_bytes
...
def interactive_setup() -> None:
    ...
    ``roveagent_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where RoveAgent delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # roveagent_cli/setup.py::_setup_mattermost function.
