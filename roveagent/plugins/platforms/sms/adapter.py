...
from roveagent.gateway.platforms.helpers import redact_phone, strip_markdown
...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> RoveAgent gateway adapter.

    Each inbound phone number gets its own RoveAgent session (multi-tenant).
...
# static dict in roveagent_cli/gateway.py, and the _send_sms dispatch in
