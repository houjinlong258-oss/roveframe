...
from roveagent.core.auxiliary_client import async_call_llm, extract_content_or_reasoning
...
from roveagent.plugins.teams_pipeline.models import (
    MeetingArtifact,
    TeamsMeetingPipelineJob,
    TeamsMeetingRef,
    TeamsMeetingSummaryPayload,
)
from roveagent.plugins.teams_pipeline.store import TeamsPipelineStore
...
class TeamsMeetingPipeline:
    ...
    async def _transcribe_recording(
        ...
        temp_root = self.config.tmp_dir or (get_roveagent_home() / "tmp" / "teams_pipeline")
