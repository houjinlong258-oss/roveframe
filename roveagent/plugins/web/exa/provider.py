...
def _get_exa_client() -> Any:
    ...
    client.headers["x-exa-integration"] = "roveagent-agent"
...
class ExaWebSearchProvider(WebSearchProvider):
    ...
    def search(self, query: str, limit: int = 5) -> Dict[str, Any]:
        ...
        try:
            ...
            from roveagent.plugins.web.keyless_mcp import search_with_failover, use_keyless
    ...
    def extract(self, urls: List[str], **kwargs: Any) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            from roveagent.plugins.web.keyless_mcp import extract_with_failover, use_keyless
