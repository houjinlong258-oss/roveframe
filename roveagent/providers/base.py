...
def _profile_user_agent() -> str:
    """Return a ``roveagent-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from roveagent.clisupport import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"roveagent-cli/{_ver}"
    except Exception:
        return "roveagent-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # roveagent-cli UA so the catalog endpoint is reachable.
