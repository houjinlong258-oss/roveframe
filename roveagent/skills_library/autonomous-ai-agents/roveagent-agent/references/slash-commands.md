...
Registry of record: `roveagent_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore RoveAgent config+state snapshots (CLI)
...
/update                  Update RoveAgent to latest
