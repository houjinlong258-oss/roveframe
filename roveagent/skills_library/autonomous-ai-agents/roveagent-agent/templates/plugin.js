/**
 * RoveAgent desktop plugin template. Save as:
 *   <roveagent home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <roveagent home> is ~/.roveagent by default, or ~/.roveagent/profiles/<name>
 * when running a named profile (`roveagent -p <name>`). Run `roveagent doctor` (or
 ...
 * Only these imports resolve: @roveagent/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@roveagent/plugin-sdk'
