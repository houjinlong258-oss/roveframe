...
Built for [RoveAgent Agent](https://github.com/NousResearch/roveagent-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/roveagent-agent/skills/creative/ascii-video`](https://github.com/NousResearch/roveagent-agent/tree/main/skills/creative/ascii-video) via PR.
