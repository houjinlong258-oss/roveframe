#!/usr/bin/env python3
"""Leave a mark on the page in the RoveAgent desktop GUI's in-app browser.
...
def annotate_preview_tool(
    ...
    if callback is None:
        return tool_error("annotate_preview is only available in the RoveAgent desktop app.")
