...
from roveagent.tools.browser_extension_router import routed_browser_handler
...
# ``websockets`` is a direct roveagent-agent dependency because the browser CDP
...
def _resolve_cdp_endpoint() -> str:
    ...
    """
    try:
        from roveagent.tools.browser_tool import _get_cdp_override  # type: ignore[import-not-found]
...
def _browser_cdp_private_guard(
    *,
    ...
    """
    try:
        from roveagent.tools import browser_tool as bt  # type: ignore[import-not-found]
...
def _browser_cdp_check() -> bool:
    ...
    """
    try:
        from roveagent.tools.browser_tool import (  # type: ignore[import-not-found]
