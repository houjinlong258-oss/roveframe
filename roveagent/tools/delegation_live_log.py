...
per child under::
    ...
    <roveagent_home>/cache/delegation/live/<delegation_id>/task-<n>.log
...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.roveagent)."""
    from roveagent.constants import get_roveagent_dir

    return get_roveagent_dir("cache/delegation", "delegation_cache") / "live"
...
class LiveTranscriptWriter:
    ...
    def __init__(self, delegation_id: str, task_index: int, goal: str,
        ...
        try:
            ...
            header = [
                "=== RoveAgent subagent live transcript ===",
