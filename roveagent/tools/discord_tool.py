...
Only included in the roveagent-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "RoveAgent-Agent (https://github.com/NousResearch/roveagent-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_roveagent_home() / "cache" / "discord_capabilities.json"
