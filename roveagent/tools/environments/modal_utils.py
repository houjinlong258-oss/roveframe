"""Shared RoveAgent-side execution flow for Modal transports.

This module deliberately stops at the RoveAgent boundary:
- command preparation
...
from roveagent.tools.environments.base import BaseEnvironment
...
def wrap_modal_stdin_heredoc(command: str, stdin_data: str) -> str:
    ...
    marker = f"ROVEAGENT_EOF_{uuid.uuid4().hex[:8]}"
