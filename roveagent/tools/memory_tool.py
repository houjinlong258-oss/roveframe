...
from roveagent.tools.registry import no_cache_check_fn
...
from roveagent.tools.threat_patterns import first_threat_message as _first_threat_message
...
def _memory_target_error(store: "MemoryStore", target: str) -> Optional[Dict[str, Any]]:
    ...
    if target not in {"memory", "user"}:
        from roveagent.tools.registry import _bound_error_text
