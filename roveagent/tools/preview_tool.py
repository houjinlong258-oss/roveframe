...
from roveagent.tools.open_preview_tool import _normalize_target, open_preview_tool
...
PREVIEW_SCHEMA = {
    ...
    "description": (
        "The preview pane beside the chat in the RoveAgent desktop app. open: show "
