#!/usr/bin/env python3
"""Let the agent react to a message with an emoji in the RoveAgent desktop app.
...
from roveagent.tools import desktop_ui
...
def react_to_message_tool(emoji: str, message_row_id=None, messages_back=None) -> str:
    ...
    session_key = get_session_env("ROVEAGENT_SESSION_KEY", "") or get_session_env(
