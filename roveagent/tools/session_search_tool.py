...
the get_anchored_view / get_messages_around primitives in roveagent_state.
...
from roveagent.state.common import _RESET_END_REASONS

# Sources that are excluded from session browsing/searching by default.
# Third-party integrations tag their sessions with ROVEAGENT_SESSION_SOURCE=tool;
...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Search past RoveAgent sessions (FTS5 over the local session DB), or read/"
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another RoveAgent profile's database "
