#!/usr/bin/env python3
"""Run a guided tour (highlight + narrate UI elements) in the RoveAgent desktop GUI.
...
- ``surface="app"`` — the RoveAgent desktop app's own DOM (tours of RoveAgent itself).
...
def tour_tool(
    ...
    if callback is None:
        return tool_error("tour is only available in the RoveAgent desktop app.")
...
TOUR_SCHEMA = {
    ...
    "description": (
        ...
        "element, attach a titled popover. Surfaces: 'app' (RoveAgent itself) "
