...
def _resolve_stt_client_config() -> Dict[str, Any]:
    from roveagent.tools import transcription_tools as tt
...
def _resolve_tts_client_config() -> Dict[str, Any]:
    from roveagent.tools import tts_tool as tts
...
def resolve_client_voice_config() -> Dict[str, Any]:
    ...
    Callers scope the profile via ``roveagent_constants.set_roveagent_home_override``
