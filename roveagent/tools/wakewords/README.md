...
`hey_roveagent.onnx` / `hey_roveagent.tflite` — the on-device "Hey RoveAgent" hotword
...
- **Label:** the model registers as `hey_roveagent` (matches the filename).
